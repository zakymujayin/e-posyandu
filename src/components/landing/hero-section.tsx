        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-lg">
            <AnimateOnScroll delay={0}>
              {/* Badge — rounded-md untuk kesan lebih formal */}
              <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 text-xs font-semibold px-3 py-1.5 rounded-md mb-6">
            ...
            <AnimateOnScroll delay={2}>
              {/* Tagline — border-left biru, lebih formal */}
              <div className="border-l-2 border-blue-300 pl-3 mb-4">
                <p className="text-sm text-slate-500 italic" style={{ fontFamily: "var(--font-jakarta)" }}>
